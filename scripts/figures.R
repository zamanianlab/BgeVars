...
setwd("~/GitHub/BgeVars/auxillary/snpeff/")
...
# classify effects
# remove "frameshift_variant", "exon_loss_variant", because only SNVs were included in filtering strategy
...
# because only SNVs were included in filtering strategy
...
# count the number of genes that have eact SNV effect and classify by impact; cutoff number of genes at 2000 to help visualization
...
save_plot("Fig2A.pdf", fig2a, base_width = 8, base_height = 10, units = "in")
...
save_plot("Fig2B.pdf", fig2b, base_width = 11, base_height = 8.5, units = "in")

##### Combine Figure 2 #####

fig2 <- plot_grid(fig2a, fig2b, labels = c("a", "b"), nrow = 1, rel_widths = c(1, 1.2))
save_plot("Fig2.pdf", fig2, base_width = 15, base_height = 6.5)
...
save_plot("Fig3A.pdf", fig3a, base_width = 6, base_height = 6)
...
save_plot("Fig3B.pdf", fig3b, base_width = 8.5, base_height = 11)

##### Figure 3C #####

setwd("~/GitHub/BgeVars/auxillary/freq/")
...
save_plot("Fig3C.pdf", fig3c, base_width = 8.5, base_height = 11)
...
save_plot("Fig3.pdf", fig3, base_width = 10.5, base_height = 9, units = "in")
...
setwd("~/GitHub/BgeVars/auxillary/karyotype/")
...
save_plot("Fig4A.pdf", fig4a, base_width = 5, base_height = 15, units = "in")
...
save_plot("Fig4B.pdf", fig4b, base_width = 14, base_height = 10, units = "in")
...
bottom_row <- plot_grid(fig4c, fig4d, labels = c("c", "d"), rel_widths = c(2,2), label_size = 15)
fig4 <- plot_grid(top_row, NULL, bottom_row, labels = c("", "", ""), ncol = 1, rel_heights = c(1.5, 0.1, 1), align = 'v', axis ='l')

save_plot("Fig4.pdf", fig4, base_height = 10, base_width = 12)
...
save_plot("Additional_file_2.pdf", sfig2, base_width = 18, base_aspect_ratio = .5, units = "in")
...
save_plot("Additional_file_3A.pdf", sfig3a, base_width = 18, base_height = 6, units = "in")
...
save_plot("Additional_file_3B.pdf", sfig3b, base_width = 18, base_height = 6, units = "in")

sfig3 <- plot_grid(sfig3a, sfig3b, labels = c("a", "b"), nrow = 2)

save_plot("Additional_file_3.pdf", sfig3, base_width = 18, base_aspect_ratio = 0.5)
