...
bcftools mpileup -Ou -C50 --threads 4 -f "${local_dir}/BglaB1.5.fa" "${local_dir}/CA301ANXX.bam" | bcftools call -mv --threads 4 --ploidy "${gh_dir}/auxillary/ploidy_file.txt" -A -Oz  > "${local_dir}/bcftools.raw.bcf"
